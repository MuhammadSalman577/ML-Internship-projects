...
Spam email detection model is first trained on labeled dataset. During the preprocessing the dataset with Text label which contains the actual email is refined and normalized first through stemming and than vectorized for the model to make training simple and than dataset is fed in to the model for training.
